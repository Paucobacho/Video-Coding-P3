...
def hls_container(video_path):
    ...
    -hls_segment_filename resources/stream_%v/data%02d.ts \
    -master_pl_name resources/master.m3u8 \
    -var_stream_map "v:0,a:0 v:1,a:1 v:2,a:2" resources/stream_%v.m3u8'.format(video_path)

    os.system(string)


hls_container(source)
